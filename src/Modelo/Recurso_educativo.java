...
public class Recurso_educativo {
    ...
    private LocalDateTime fecha_cargp;
    private String tipo_rec_ed;

    public Recurso_educativo() {
    }

    public Recurso_educativo(String codigo_rec_ed, LocalDateTime fecha_cargp, String tipo_rec_ed) {
    ...
    public LocalDateTime getFecha_cargp() {
        return fecha_cargp;
    }

    public void setFecha_cargp(LocalDateTime fecha_cargp) {
        this.fecha_cargp = fecha_cargp;
    }
