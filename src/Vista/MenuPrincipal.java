...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    // Mostrar una imagen aleatoria en el jLabelImagenMenu
     private void displayRandomImage() {
        if (imageFiles != null && imageFiles.length > 0) {
            int randomIndex = random.nextInt(imageFiles.length);
            File selectedImage = imageFiles[randomIndex];
            ...
            Image scaledImage = image.getScaledInstance(jLabelImagenMenu.getWidth(), jLabelImagenMenu.getHeight(), Image.SCALE_SMOOTH);
            ImageIcon scaledIcon = new ImageIcon(scaledImage);

            jLabelImagenMenu.setIcon(scaledIcon);
        }
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Registrar Reciclaje");
        jButton2.setToolTipText("");
        jButton2.setActionCommand("ReReciclaje");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelImagenMenu, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(21, 21, 21)
                .addComponent(jLabelImagenMenu, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private javax.swing.JLabel jLabelImagenMenu;
